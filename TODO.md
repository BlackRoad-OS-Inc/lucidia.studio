...
> Active tasks for Lucidia Studio

## [RC] Priority 1 — Ship Now

- [ ] [RC] Deploy live website to lucidia.studio via Gematria/Caddy
...
- [ ] [RC] Write product landing copy for: Creator Studio, RoadView, Canvas, Video, Writing, Cadence
